...
These experiences confirmed my interest in the topic and made me want
to explore it further, in a more structured and long-term setting.

I’m eager to start this journey, to grow as a researcher, and to work
...
in distributed systems. While MPST traditionally targets peer-to-peer
communication, real-world systems often rely on different models, such
as mailbox-based or causally ordered communication. A key challenge
is that implementability does not always carry over between models.
To address this, a new parametric MPST theory has been proposed,
supporting diverse communication semantics, and relying on the concept
of quasi-synchronous systems to ensure implementability through
specific semantic conditions.

The goal of the internship is to develop a tool that implements these
algorithms. This includes extending an existing tool to support the
broader class of quasi-synchronous systems and exploring deadlock
freedom guarantees. The work will also involve a literature review on
communicating automata, monadic second-order logic, and behavioral
theories.