...
%   block/.style={rectangle, draw=blue!60, fill=blue!10, rounded corners,
%                     text width=8em, align=center, minimum height=2.5em}]

% \node[block] (g) {Global Specification};
% \node[block, below=of g] (l) {Project to Local Views};
% \node[block, below=of l] (i) {Implement Local Functions};
