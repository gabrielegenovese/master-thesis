...
\paragraph{Sort Types}
Sort types are defined as:
\begin{equation}
    S ::= nat \mid int \mid bool \mid ...
\end{equation}
...
\begin{equation}
G ::= p \to q : \langle S \rangle . G \mid p \to q : \langle l_i : G_i \rangle_{i \in I}  \mid \mu t. G \mid t \mid \text{end}
\end{equation}

where:
\begin{itemize}
    \item $p, q$ are participants in the communication,
    \item the communication with $S$ will send a value,
    \item $l_i : G_i$ represents a branching of possible execution,
