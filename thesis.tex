...
l’assenza di deadlock e la conformità alla sessione, è una preoccupazione
centrale negli MPST.  
...
modello possono fallire in un altro.  
In questo lavoro sviluppiamo un quadro MPST flessibile parametrizzato da diverse
semantiche di rete, tra cui asincrona, peer-to-peer, con ordinamento
...
fondamentali. I miei contributi includono una rassegna dei lavori correlati, una
dimostrazione di indecidibilità per la debole implementabilità sotto semantica
sincrona e miglioramenti allo strumento \textsc{ReSCu} per la verifica
...
una base per la verifica dei sistemi distribuiti oltre gli scenari classici. 
\thispagestyle{plain}
\topmargin=-1cm
\cleardoublepage
