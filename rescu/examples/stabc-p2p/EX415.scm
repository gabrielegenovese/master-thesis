...
state 4 :
to 2 : when true , 0 ! DMALERTFAILURE2;
...
state 6 :
to 2 : when true , 0 ! DMALERTFAILURE1;
...
to 93 : when true , 5 ! DMFAILED2;

state 188 :
to 195 : when true , 4  ? VM2FAILED;
...
state 145 :
to 164 : when true , 4  ? VM2FAILED;
to 61 : when true , 1 ! VM1RESETINSTANCE;

state 15 :
to 20 : when true , 3  ? VM1FAILED;
to 21 : when true , 5 ! DMFAILED2;

state 121 :
to 146 : when true , 4  ? VM2FAILED;
to 44 : when true , 1 ! VM1RESETINSTANCE;
to 145 : when true , 0  ? DMALERTFAILURE1;

state 152 :
to 161 : when true , 0  ? DMALERTFAILURE2;

state 160 :
to 76 : when true , 2 ! VM2ALERTFAILURE;
to 169 : when true , 5 ! DMFAILED1;

state 54 :
to 70 : when true , 4  ? VM2FAILED;
to 9 : when true , 2 ! VM2ALERTFAILURE;
to 69 : when true , 3  ? VM1FAILED;

state 140 :
to 163 : when true , 4  ? VM2FAILED;
to 61 : when true , 2 ! VM2ALERTFAILURE;
to 161 : when true , 3  ? VM1FAILED;
to 50 : when true , 1 ! VM1ALERTFAILURE;

state 77 :
to 91 : when true , 4  ? VM2FAILED;
to 90 : when true , 5 ! DMFAILED1;

state 159 :
to 169 : when true , 2 ! VM2NEWAZUREVM;
to 168 : when true , 0  ? DMINSTANTIATE1;
...
to 22 : when true , 0  ? DMINSTANTIATE2;

state 21 :
to 31 : when true , 3  ? VM1FAILED;
to 30 : when true , 0  ? DMINSTANTIATE2;

state 131 :
to 44 : when true , 2 ! VM2NEWAZUREVM;
to 42 : when true , 3  ? VM1FAILED;
to 43 : when true , 0  ? DMALERTFAILURE1;

state 68 :
to 85 : when true , 4  ? VM2FAILED;
to 12 : when true , 2 ! VM2ALERTFAILURE;
to 84 : when true , 5 ! DMFAILED1;

state 85 :
to 98 : when true , 5 ! DMFAILED2;

state 105 :
to 128 : when true , 2 ! VM2NEWAZUREVM;
to 127 : when true , 3  ? VM1FAILED;
to 126 : when true , 1 ! VM1ALERTFAILURE;
to 118 : when true , 0  ? DMALERTFAILURE2;

state 63 :
to 78 : when true , 4  ? VM2FAILED;
to 77 : when true , 0  ? DMALERTFAILURE1;
...
to 118 : when true , 0  ? DMALERTFAILURE1;
...
to 176 : when true , 0  ? DMINSTANTIATE1;

state 22 :
to 34 : when true , 2 ! VM2NEWAZUREVM;
to 33 : when true , 1 ! VM1ADDINSTANCE;
to 32 : when true , 0  ? DMALERTFAILURE1;

state 65 :
to 82 : when true , 1 ! VM1ADDINSTANCE;
to 81 : when true , 5 ! DMFAILED2;

state 44 :
to 64 : when true , 4  ? VM2FAILED;
to 63 : when true , 3  ? VM1FAILED;
to 62 : when true , 0  ? DMALERTFAILURE1;

state 5 :
to 10 : when true , 4  ? VM2FAILED;
...
to 80 : when true , 0  ? DMALERTFAILURE1;
...
to 110 : when true , 0  ? DMINSTANTIATE1;

state 10 :
to 17 : when true , 1 ! VM1ADDINSTANCE;
to 16 : when true , 5 ! DMFAILED2;

state 153 :
to 57 : when true , 1 ! VM1ALERTFAILURE;
to 163 : when true , 0  ? DMALERTFAILURE2;

state 39 :
to 56 : when true , 4  ? VM2FAILED;
to 55 : when true , 3  ? VM1FAILED;
to 54 : when true , 0  ? DMALERTFAILURE2;

state 126 :
to 39 : when true , 2 ! VM2NEWAZUREVM;
to 150 : when true , 3  ? VM1FAILED;
to 149 : when true , 0  ? DMALERTFAILURE2;

state 108 :
to 129 : when true , 0  ? DMINSTANTIATE1;

state 52 :
to 73 : when true , 1 ! VM1RESETINSTANCE;
to 72 : when true , 5 ! DMFAILED2;
...
state 185 :
to 129 : when true , 4  ? VM2FAILED;
to 128 : when true , 1 ! VM1RESETINSTANCE;
to 124 : when true , 0  ? DMALERTFAILURE2;

state 14 :
to 20 : when true , 4  ? VM2FAILED;
to 19 : when true , 5 ! DMFAILED1;
...
to 102 : when true , 0  ? DMALERTFAILURE2;

state 79 :
to 12 : when true , 2 ! VM2NEWAZUREVM;
to 92 : when true , 5 ! DMFAILED1;
...
to 94 : when true , 0  ? DMINSTANTIATE2;

state 128 :
to 153 : when true , 4  ? VM2FAILED;
to 152 : when true , 3  ? VM1FAILED;
to 39 : when true , 1 ! VM1ALERTFAILURE;
to 141 : when true , 0  ? DMALERTFAILURE2;

state 70 :
to 85 : when true , 3  ? VM1FAILED;
to 86 : when true , 5 ! DMFAILED2;
...
to 37 : when true , 0  ? DMALERTFAILURE2;
...
to 70 : when true , 0  ? DMALERTFAILURE2;
...
to 40 : when true , 0  ? DMALERTFAILURE2;

state 38 :
to 53 : when true , 2 ! VM2NEWAZUREVM;
to 49 : when true , 0  ? DMALERTFAILURE2;

state 74 :
to 85 : when true , 0  ? DMALERTFAILURE2;
...
to 89 : when true , 0  ? DMINSTANTIATE1;

state 123 :
to 147 : when true , 4  ? VM2FAILED;
...
to 165 : when true , 5 ! DMFAILED2;

state 53 :
to 74 : when true , 4  ? VM2FAILED;
to 69 : when true , 0  ? DMALERTFAILURE2;
...
to 58 : when true , 0  ? DMALERTFAILURE1;
...
to 23 : when true , 0  ? DMALERTFAILURE2;
...
to 147 : when true , 0  ? DMALERTFAILURE1;

state 143 :
to 163 : when true , 0  ? DMALERTFAILURE1;
...
state 19 :
to 27 : when true , 4  ? VM2FAILED;
to 26 : when true , 0  ? DMINSTANTIATE1;

state 172 :
to 93 : when true , 1 ! VM1RESETINSTANCE;
to 179 : when true , 0  ? DMINSTANTIATE2;

state 117 :
to 138 : when true , 2 ! VM2NEWAZUREVM;
to 137 : when true , 0  ? DMALERTFAILURE1;
...
state 150 :
to 53 : when true , 2 ! VM2NEWAZUREVM;
to 162 : when true , 0  ? DMALERTFAILURE2;
...
to 101 : when true , 0  ? DMINSTANTIATE2;

state 84 :
to 19 : when true , 2 ! VM2ALERTFAILURE;
to 97 : when true , 0  ? DMINSTANTIATE1;
...
to 178 : when true , 0  ? DMINSTANTIATE2;

state 34 :
to 48 : when true , 4  ? VM2FAILED;
to 44 : when true , 1 ! VM1ADDINSTANCE;
to 47 : when true , 0  ? DMALERTFAILURE1;

state 127 :
to 151 : when true , 2 ! VM2NEWAZUREVM;
to 137 : when true , 0  ? DMALERTFAILURE2;
...
to 88 : when true , 0  ? DMINSTANTIATE2;

state 93 :
to 21 : when true , 1 ! VM1ALERTFAILURE;
to 111 : when true , 0  ? DMINSTANTIATE2;

state 119 :
to 143 : when true , 4  ? VM2FAILED;
to 44 : when true , 2 ! VM2ALERTFAILURE;
to 142 : when true , 3  ? VM1FAILED;
to 141 : when true , 0  ? DMALERTFAILURE1;
...
to 102 : when true , 0  ? DMALERTFAILURE1;
...
state 20 :
to 29 : when true , 5 ! DMFAILED2;
to 28 : when true , 5 ! DMFAILED1;

state 129 :
to 154 : when true , 1 ! VM1RESETINSTANCE;
to 147 : when true , 0  ? DMALERTFAILURE2;
...
state 49 :
to 68 : when true , 2 ! VM2NEWAZUREVM;
to 67 : when true , 5 ! DMFAILED1;

state 62 :
to 80 : when true , 4  ? VM2FAILED;
...
state 78 :
to 91 : when true , 0  ? DMALERTFAILURE1;
...
state 9 :
to 15 : when true , 4  ? VM2FAILED;
to 14 : when true , 3  ? VM1FAILED;

state 51 :
to 71 : when true , 4  ? VM2FAILED;
...
to 164 : when true , 0  ? DMALERTFAILURE1;

state 90 :
to 108 : when true , 4  ? VM2FAILED;
to 107 : when true , 0  ? DMINSTANTIATE1;
...
to 173 : when true , 0  ? DMINSTANTIATE2;
...
to 75 : when true , 5 ! DMFAILED1;

state 170 :
to 84 : when true , 2 ! VM2NEWAZUREVM;
to 177 : when true , 0  ? DMINSTANTIATE1;
...
to 65 : when true , 0  ? DMALERTFAILURE1;

state 71 :
to 17 : when true , 1 ! VM1RESETINSTANCE;
to 87 : when true , 5 ! DMFAILED2;
...
state 47 :
to 65 : when true , 4  ? VM2FAILED;
to 61 : when true , 1 ! VM1ADDINSTANCE;

state 91 :
to 109 : when true , 5 ! DMFAILED1;
...
to 52 : when true , 0  ? DMALERTFAILURE2;
...
to 99 : when true , 0  ? DMINSTANTIATE2;
