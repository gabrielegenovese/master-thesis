...
state 104 :
to 111 : when true , 0 ! A1;
to 109 : when true , 0 ! D1;
...
state 103 :
to 110 : when true , 0 ! A1;
to 109 : when true , 0 ! C1;

state 102 :
to 108 : when true , 0 ! C1;
to 107 : when true , 0 ! D1;
to 105 : when true , 0 ! B1;
...
state 100 :
to 107 : when true , 0 ! A1;
to 106 : when true , 0 ! C1;
to 103 : when true , 0 ! B1;
...
state 105 :
to 111 : when true , 0 ! C1;
to 110 : when true , 0 ! D1;
...
state 108 :
to 112 : when true , 0 ! D1;
to 111 : when true , 0 ! B1;
...
state 106 :
to 112 : when true , 0 ! A1;
to 109 : when true , 0 ! B1;

state 14 :
to 16 : when true , 0 ! C;

state 111 :
to 113 : when true , 0 ! D1;
...
state 101 :
to 108 : when true , 0 ! A1;
to 106 : when true , 0 ! D1;
to 104 : when true , 0 ! B1;
...
state 98 :
to 102 : when true , 0 ! A1;
to 101 : when true , 0 ! C1;
to 100 : when true , 0 ! D1;
to 99 : when true , 0 ! B1;
...
state 107 :
to 112 : when true , 0 ! C1;
to 110 : when true , 0 ! B1;
...
state 97 :
to 98 : when true , 1  ? SS;

state 99 :
to 105 : when true , 0 ! A1;
to 104 : when true , 0 ! C1;
to 103 : when true , 0 ! D1;
...
state 103 :
to 110 : when true , 0  ? A1;
to 108 : when true , 0  ? D1;

state 102 :
to 109 : when true , 0  ? A1;
to 108 : when true , 0  ? C1;
...
state 98 :
to 104 : when true , 0  ? A1;
to 103 : when true , 0  ? C1;
to 102 : when true , 0  ? D1;
...
state 97 :
to 101 : when true , 0  ? A1;
to 100 : when true , 0  ? C1;
to 99 : when true , 0  ? D1;
to 98 : when true , 0  ? B1;

state 99 :
to 106 : when true , 0  ? A1;
to 105 : when true , 0  ? C1;
to 102 : when true , 0  ? B1;
...
state 80 :
to 84 : when true , 5  ? Z1;
to 83 : when true , 5  ? Z3;
to 82 : when true , 5  ? Z4;
to 81 : when true , 5  ? Z2;

state 104 :
to 110 : when true , 5  ? Z11;
to 107 : when true , 5  ? Z22;
...
state 103 :
to 109 : when true , 5  ? Z33;
to 108 : when true , 5  ? Z44;

state 102 :
to 109 : when true , 5  ? Z11;
to 107 : when true , 5  ? Z44;
...
state 100 :
to 106 : when true , 5  ? Z33;
to 105 : when true , 5  ? Z44;
to 103 : when true , 5  ? Z22;
...
state 105 :
to 110 : when true , 5  ? Z33;
to 108 : when true , 5  ? Z22;
...
state 87 :
to 93 : when true , 5  ? Z3;
to 92 : when true , 5  ? Z4;

state 84 :
to 90 : when true , 5  ? Z3;
to 89 : when true , 5  ? Z4;
...
state 88 :
to 94 : when true , 5  ? Z1;
to 91 : when true , 5  ? Z2;
...
state 106 :
to 110 : when true , 5  ? Z44;
to 109 : when true , 5  ? Z22;
...
state 82 :
to 89 : when true , 5  ? Z1;
to 88 : when true , 5  ? Z3;
to 85 : when true , 5  ? Z2;
...
state 101 :
to 108 : when true , 5  ? Z11;
to 107 : when true , 5  ? Z33;
...
state 96 :
to 100 : when true , 5  ? Z11;
to 99 : when true , 5  ? Z33;
to 98 : when true , 5  ? Z44;
to 97 : when true , 5  ? Z22;
...
to 86 : when true , 5  ? Z3;
to 85 : when true , 5  ? Z4;
...
state 98 :
to 105 : when true , 5  ? Z11;
to 104 : when true , 5  ? Z33;
to 101 : when true , 5  ? Z22;
...
state 97 :
to 103 : when true , 5  ? Z11;
to 102 : when true , 5  ? Z33;
to 101 : when true , 5  ? Z44;

state 99 :
to 106 : when true , 5  ? Z11;
to 104 : when true , 5  ? Z44;
to 102 : when true , 5  ? Z22;
...
state 83 :
to 90 : when true , 5  ? Z1;
to 88 : when true , 5  ? Z4;
to 86 : when true , 5  ? Z2;
