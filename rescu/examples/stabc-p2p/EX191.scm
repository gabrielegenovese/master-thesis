...
state 18 :
to 25 : when true , 5  ? Z2;
to 24 : when true , 5  ? Z4;
to 21 : when true , 5  ? Z1;
...
state 23 :
to 29 : when true , 5  ? Z4;
to 28 : when true , 5  ? Z3;
...
state 16 :
to 20 : when true , 5  ? Z2;
to 19 : when true , 5  ? Z4;
to 18 : when true , 5  ? Z3;
to 17 : when true , 5  ? Z1;

state 24 :
to 30 : when true , 5  ? Z2;
to 27 : when true , 5  ? Z1;
...
state 19 :
to 26 : when true , 5  ? Z2;
to 24 : when true , 5  ? Z3;
to 22 : when true , 5  ? Z1;

state 32 :

state 17 :
to 23 : when true , 5  ? Z2;
to 22 : when true , 5  ? Z4;
to 21 : when true , 5  ? Z3;
...
state 20 :
to 26 : when true , 5  ? Z4;
to 25 : when true , 5  ? Z3;
