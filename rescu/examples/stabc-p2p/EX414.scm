...
to 23 : when true , 0  ? DMALERTFAILURE;

state 50 :
to 58 : when true , 3  ? VM1FAILED;
to 15 : when true , 0  ? DMALERTFAILURE;
...
state 26 :
to 39 : when true , 4  ? VM2FAILED;
to 37 : when true , 1 ! VM1RESETINSTANCE;
to 38 : when true , 0  ? DMALERTFAILURE;
...
state 60 :
to 20 : when true , 0  ? DMALERTFAILURE;

state 27 :
to 39 : when true , 0  ? DMINSTANTIATE1;

state 34 :
to 45 : when true , 4  ? VM2FAILED;
to 42 : when true , 1 ! VM1ADDINSTANCE;
to 44 : when true , 0  ? DMALERTFAILURE;

state 22 :
to 34 : when true , 2 ! VM2NEWAZUREVM;
to 33 : when true , 1 ! VM1ADDINSTANCE;
to 32 : when true , 0  ? DMALERTFAILURE;
...
to 41 : when true , 0  ? DMALERTFAILURE;
...
to 46 : when true , 0  ? DMALERTFAILURE;
...
state 31 :
to 40 : when true , 0  ? DMINSTANTIATE2;
...
to 48 : when true , 0  ? DMALERTFAILURE;
