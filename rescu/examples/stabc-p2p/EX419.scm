...
state 18 :
to 19 : when true , 2  ? LBRESULT;

state 19 :
to 20 : when true , 5 ! CLIENTRESULT;
...
state 28 :
to 29 : when true , 5 ! CLIENTRESULT;
...
state 16 :
to 17 : when true , 7  ? VM2RESULT;

state 24 :
to 25 : when true , 3 ! VM1REQ;

state 14 :
to 16 : when true , 6 ! VM2REQUEST;
...
state 29 :
to 30 : when true , 0  ? CLIENTREQUEST;

state 2 :
to 3 : when true , 2  ? LBCOMPUTE;

state 20 :
to 21 : when true , 0  ? CLIENTREQUEST;
