...
state 50 :
to 57 : when true , 3  ? Z2;
to 56 : when true , 3  ? Z4;
to 53 : when true , 3  ? Z1;
...
to 54 : when true , 3  ? Z4;
to 53 : when true , 3  ? Z3;

state 52 :
to 58 : when true , 3  ? Z4;
to 57 : when true , 3  ? Z3;
...
state 56 :
to 62 : when true , 3  ? Z2;
to 59 : when true , 3  ? Z1;
...
state 51 :
to 58 : when true , 3  ? Z2;
to 56 : when true , 3  ? Z3;
to 54 : when true , 3  ? Z1;
...
state 55 :
to 61 : when true , 3  ? Z4;
to 60 : when true , 3  ? Z3;
...
state 48 :
to 52 : when true , 3  ? Z2;
to 51 : when true , 3  ? Z4;
to 50 : when true , 3  ? Z3;
to 49 : when true , 3  ? Z1;
