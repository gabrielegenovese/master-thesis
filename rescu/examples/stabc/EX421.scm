...
state 22 :
to 23 : when true , 4  ? LBCOMPUTE;

state 18 :
to 19 : when true , 0 ! CLIENTRESULT;

state 19 :
to 20 : when true , 4  ? CLIENTREQUEST;
...
state 28 :
to 29 : when true , 4  ? CLIENTREQUEST;

state 23 :
to 24 : when true , 2 ! VM1REQ;
...
state 27 :
to 28 : when true , 0 ! CLIENTRESULT;
