...
state 0 :
to 1 : when true , 8  ? K34;

state 4 :
to 5 : when true , 9 ! K35;
...
state 1 :
to 2 : when true , 10 ! K36;

state 0 :
to 1 : when true , 9  ? K35;
...
state 3 :
to 4 : when true , 10 ! BEL;

state 2 :
to 3 : when true , 12  ? BON;
