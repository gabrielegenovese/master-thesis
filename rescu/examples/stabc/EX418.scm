...
state 12 :
to 16 : when true , 4  ? VM1RES;

state 8 :
to 12 : when true , 3 ! VM2LOGIN;
to 11 : when true , 4  ? VM1RES;
...
state 10 :
to 13 : when true , 3 ! VM2REQUEST;
to 12 : when true , 2 ! VM1REQ;
