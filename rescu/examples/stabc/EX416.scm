...
to 24 : when true , 3  ? DMINSTANTIATE2;

state 50 :
to 58 : when true , 3  ? VM1FAILED;
to 17 : when true , 3  ? DMALERTFAILURE;

state 4 :
to 9 : when true , 2 ! VM2NEWAZUREVM;
to 8 : when true , 3  ? VM1FAILED;
to 6 : when true , 3  ? DMALIVE;

state 8 :
to 13 : when true , 2 ! VM2NEWAZUREVM;
to 12 : when true , 0 ! DMFAILED1;
to 8 : when true , 3  ? DMALIVE;

state 54 :
to 60 : when true , 3  ? VM2FAILED;
to 16 : when true , 3  ? DMALERTFAILURE;
...
state 16 :
to 22 : when true , 3  ? VM2FAILED;
to 21 : when true , 0 ! DMFAILED1;
to 16 : when true , 3  ? DMALIVE;

state 21 :
to 29 : when true , 3  ? VM2FAILED;
to 28 : when true , 3  ? DMINSTANTIATE1;
...
to 63 : when true , 3  ? DMALIVE;

state 32 :
to 44 : when true , 2 ! VM2NEWAZUREVM;
to 42 : when true , 3  ? VM1FAILED;
to 43 : when true , 3  ? DMALERTFAILURE;

state 19 :
to 22 : when true , 3  ? VM1FAILED;
to 23 : when true , 0 ! DMFAILED2;
to 17 : when true , 3  ? DMALIVE;
...
state 60 :
to 22 : when true , 3  ? DMALERTFAILURE;

state 27 :
to 41 : when true , 3  ? VM2FAILED;
to 39 : when true , 1 ! VM1RESETINSTANCE;
to 40 : when true , 3  ? DMALERTFAILURE;

state 34 :
to 5 : when true , 2 ! VM2NEWAZUREVM;
to 45 : when true , 1 ! VM1ADDINSTANCE;
to 34 : when true , 3  ? DMALIVE;

state 22 :
to 31 : when true , 0 ! DMFAILED2;
to 30 : when true , 0 ! DMFAILED1;
to 22 : when true , 3  ? DMALIVE;
...
state 5 :
to 11 : when true , 3  ? VM2FAILED;
to 9 : when true , 1 ! VM1ADDINSTANCE;
to 10 : when true , 3  ? DMALIVE;
...
to 25 : when true , 3  ? DMALERTFAILURE;

state 25 :
to 37 : when true , 2 ! VM2NEWAZUREVM;
to 4 : when true , 1 ! VM1RESETINSTANCE;
to 25 : when true , 3  ? DMALIVE;
...
state 14 :
to 17 : when true , 3  ? VM2FAILED;
to 16 : when true , 3  ? VM1FAILED;
to 14 : when true , 3  ? DMALIVE;
...
to 20 : when true , 3  ? DMINSTANTIATE1;

state 45 :
to 9 : when true , 2 ! VM2NEWAZUREVM;
to 52 : when true , 3  ? VM1FAILED;
to 43 : when true , 3  ? DMALIVE;

state 23 :
to 33 : when true , 3  ? VM1FAILED;
to 32 : when true , 3  ? DMINSTANTIATE2;

state 24 :
to 36 : when true , 2 ! VM2NEWAZUREVM;
to 35 : when true , 1 ! VM1ADDINSTANCE;
to 34 : when true , 3  ? DMALERTFAILURE;
...
to 18 : when true , 0 ! DMFAILED2;
to 11 : when true , 3  ? DMALIVE;
...
state 40 :
to 47 : when true , 3  ? VM2FAILED;
to 9 : when true , 1 ! VM1RESETINSTANCE;
to 40 : when true , 3  ? DMALIVE;
...
to 47 : when true , 3  ? DMALERTFAILURE;
...
to 11 : when true , 3  ? DMALERTFAILURE;
