...
type 'a exp =
  | Epsilon  (** Empty word *)
  | Letter of 'a  (** Word with a single letter *)
  | Union of 'a exp list  (** Union of expressions *)
  | Concat of 'a exp list  (** Concatenation of expressions *)
  | Star of 'a exp  (** Kleene closure *)
  | Plus of 'a exp  (** Strict Kleene closure *)

(** Regular expressions *)
type 'a t =
  | Empty  (** Denotes empty language (does not contain the empty word *)
  | Exp of 'a exp  (** Regular expression *)
...
val apply_regexp : 'a exp -> 'a list -> bool * 'a list
