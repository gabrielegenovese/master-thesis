...
\section{Execution, Communication Models and MSCs}
We assume a finite set of \emph{processes} 
$\Procs=\{p,q,\ldots\}$ and a finite set of 
...
\begin{lemma}[Deadlock-freedom as an MSC property]
	...
	$$
\end{lemma}
% TODO SPIEGARE PERCHE' FUNZIONA E METTERE PROVA?
