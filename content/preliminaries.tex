...
% MODIFICATO SOLO PER SYNC
The following result shows that, for
$\synchmodel$ communication model, the deadlock-freedom property 
...
\begin{lemma}[Deadlock-freedom as an MSC property]\label{lem:ddlckmsc}
	...
	Assume $\acommunicationmodel$ is $\synchmodel$.
...
Let's now give the defintions of waek and safe realisability.
...
system CFMS $\cfsms$ such that the following condition hold:
