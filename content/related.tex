...
Most positive results assume other struttural restriction, like bounded channels, 
...
\begin{itemize}
    ...
    expressivity, as many distributed coordination patterns are excluded 
    as unsafe~\cite{honda2008multiparty}.  
    ...
    decidability; as mentioned, implementability for this fragment lies in 
...
are another formalisms to describe  
...
% main results analised in this chapter.
...
% \hline
% \textbf{Finite MSCs set} & coNP-complete~\cite{alur2005realizability} & P-time~\cite{alur2005realizability} \\ 
% \hline
% \textbf{HMSCs (general)} & Undecidable~\cite{lohrey2003realizability} & Undecidable~\cite{lohrey2003realizability} \\ 
% \hline
% \textbf{Bounded HMSCs} & Undecidable~\cite{alur2005realizability} & EXPSPACE-complete~\cite{lohrey2003realizability} \\ 
% \hline
% \textbf{Regular HMSCs} & Undecidable~\cite{lohrey2003realizability} & EXPSPACE-complete~\cite{lohrey2003realizability} \\ 
% \hline
% \textbf{Globally-Cooperative HMSCs} & -- & EXPSPACE-complete~\cite{morin2002recognizable} \\ 
% \hline
% \textbf{$\mathcal{I}$-Closed HMSCs} & -- & PSPACE-complete~\cite{lohrey2003realizability} \\ 
% \hline
% \textbf{Loop-connected HMSCs} & -- & Decidable~\cite{bollig2025high} \\ 
% \hline
% \textbf{MPST (directed choice)} & -- & Decidable~\cite{honda2008multiparty} \\ 
% \hline
% \textbf{MPST (sender-driven choice)} & PSPACE-complete~\cite{stutz2024implementability} & PSPACE-complete~\cite{stutz2024implementability} \\ 
% \hline
% \textbf{MPST (mixed choice)} & Undecidable~\cite{stutz2024implementability} & Undecidable~\cite{stutz2024implementability} \\ 
% \hline
% \textbf{Protocol State Machines (PSMs)} & Decidable for restricted fragments~\cite{stutz2025automata} & Undecidable in general~\cite{stutz2025automata} \\ 
% \hline
% \textbf{Choreographic Programming} & Decidable (subset projection)~\cite{barbanera2020choreography} & Decidable~\cite{barbanera2020choreography} \\ 
% \hline
% \end{tabular}
% \caption{Summary of known complexity results for weak and safe realisability across formal models.}
