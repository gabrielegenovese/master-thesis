...
Definition~\ref{def:synch}. In Section~\ref{sec:rel}, the discussion
...
An example for this communication model is shown in Figure~\ref{fig:sync}.c.
...
% TODO: citarlo e toglierlo come questo formato, basta solo raccontarlo
\begin{theorem}
