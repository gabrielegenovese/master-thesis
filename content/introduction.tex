...
parameters of the framework. This parameterisation allows flexible 
analysis of different communication models within a unified setting.

The main contributions of this work are: 
\begin{itemize}
    \item a review, highlighting
...
in Chapter~\ref{sec:sota}, presented in a general and accessible manner, avoiding
...
\chapter{Background}\label{sec:sota}
...
\subsection{The implementability problem for MSCs}
...
\subsection{Hierarchy of communication model's semantics}
With MSCs, \cite{di2023partial} presents some interesting communication
semantics. I will describe  them informally, using examples to
...
Definition~\ref{def:synch}. Some examples are shown in 
Figure~\ref{fig:msc_examples}, whose \emph{membership} 
...
An alternative name is FIFO. An example is shown in Figure~\ref{fig:msc_examples}.b.
